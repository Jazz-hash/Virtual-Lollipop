...
const ADD_LOLLY = gql`
  mutation addLolly($color1: String!, $color2: String!, $color3: String!, $reciever: String!, $sender: String!, $message: String!) {
...
const Create = () => {
  const [color1, setColor1] = React.useState('#d52358')
  const [color2, setColor2] = React.useState('#e95946')
